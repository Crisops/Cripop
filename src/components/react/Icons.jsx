export const IconSearch = ({ handleClick }) => (
  <svg onClick={handleClick} className='w-6 h-6 text-white cursor-pointer' width='64px' height='64px' viewBox='0 0 24 24' fill='none'>
    <g id='SVGRepo_bgCarrier' strokeWidth='0' />
    <g id='SVGRepo_tracerCarrier' strokeLinecap='round' strokeLinejoin='round' />
    <g id='SVGRepo_iconCarrier'> <path d='M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' /> </g>
  </svg>
)

export const IconGitHub = () => (
  <svg className='w-6 h-6 text-white cursor-pointer' width='800px' height='800px' viewBox='0 0 20 20' version='1.1'>
...
export const IconArrowLeft = () => (
  <svg className='w-6 h-6 text-white rotate-180' width='64px' height='64px' viewBox='0 0 24 24' fill='none'>
...
export const IconClose = () => (
  ...
  <svg className='w-6 h-6 text-white' width='800px' height='800px' viewBox='0 0 24 24' fill='none'>
