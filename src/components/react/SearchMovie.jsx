...
const SearchMovie = () => {
  ...
  return (
    <form className='relative' action='/result' method='GET'>
      <div className='relative flex flex-col items-center gap-7'>
        <div className='relative flex gap-4 items-center'>
          <IconSearch />
          <div className='relative flex items-center w-72 h-5 py-5 border-b border-zinc-600'>
            <input
          ...
          <button
            type='submit'
            className={`border border-zinc-500 px-5 py-2 font-Noto_Sans text-white font-medium text-sm transition-colors duration-300 hover:bg-white hover:text-black ${error.search && 'bg-red-600 cursor-not-allowed pointer-events-none hover:bg-red-800 hover:text-white border border-red-600'}`}
          >Buscar
          </button>
        </div>
