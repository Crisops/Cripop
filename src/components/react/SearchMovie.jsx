    ...
    <form className='relative'>
      <div className='relative flex flex-col items-center gap-4'>
        <div className='flex gap-4 items-center'>
          ...
          <button
            type='submit'
            className='border border-zinc-500 px-5 py-2 font-Noto_Sans text-white font-medium text-sm transition-colors duration-300 hover:bg-white hover:text-black'
          >Buscar
          </button>
        </div>
        <div className='flex w-full items-center gap-4'>
          <div className='flex items-center gap-2'>
            <input className='hidden peer/movie' type='radio' name='choose' id='movie' value='movie' />
          ...
          <div className='flex items-center gap-2'>
            <input className='hidden peer/tv' type='radio' name='choose' id='series' value='tv' />
